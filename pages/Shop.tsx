...
const MOCK_PRODUCTS: Product[] = [
  { id: '1', name: 'Monstera Deliciosa', price: 1450, category: 'Indoor', image: '/public/images/indoor.jfif', maintenance: 'Medium', light: 'Indirect', description: 'Classic Swiss Cheese Plant, grown in climate-controlled polyhouses for superior leaf health.' },
