...
const MOCK_PRODUCTS: Product[] = [
 {
  ...
  { id: '7', name: 'Snake Plant (Sansevieria)', price: 2800, category: 'Indoor', image: '/images/indoor/Snake_Plant.webp', maintenance: 'High', light: 'Direct', description: 'Architectural statement plant. Highly robust, acclimatized to Indian coastal conditions.' },
