...
const MOCK_PRODUCTS: Product[] = [
 {
  ...
  { id: '40', name: 'Dahlia', price: 2800, category: 'Outdoor', image: '/images/outdoor/Dahlia.avif', maintenance: 'High', light: 'Direct', description: 'Architectural statement plant. Highly robust, acclimatized to Indian coastal conditions.' },
  { id: '41', name: 'Chrysanthemum ', price: 2800, category: 'Outdoor', image: '/images/outdoor/Chrysanthemum.jpg', maintenance: 'High', light: 'Direct', description: 'Architectural statement plant. Highly robust, acclimatized to Indian coastal conditions.' },
  { id: '42', name: 'Begonia ', price: 2800, category: 'Outdoor', image: '/images/outdoor/Begonia.jfif', maintenance: 'High', light: 'Direct', description: 'Architectural statement plant. Highly robust, acclimatized to Indian coastal conditions.' },
  { id: '43', name: 'Geranium ', price: 2800, category: 'Outdoor', image: '/images/outdoor/Geranium.jpg', maintenance: 'High', light: 'Direct', description: 'Architectural statement plant. Highly robust, acclimatized to Indian coastal conditions.' },
