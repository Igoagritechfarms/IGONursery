...
const MOCK_PRODUCTS: Product[] = [
  { id: '1', name: 'Monstera Deliciosa', price: 1450, category: 'Indoor', image: '', maintenance: 'Medium', light: 'Indirect', description: 'Classic Swiss Cheese Plant, grown in climate-controlled polyhouses for superior leaf health.' },
      ...
      <section className="bg-gray-50 border-t mt-20 py-16">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            ...
            <div className="flex flex-col items-center">
                ...
                <h4 className="font-bold text-xl mb-2">15-Day Free Returnssssssssssss</h4>
